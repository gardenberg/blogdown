...
2. Anslag på faktisk populasjonsparameter. Hvor stor andel i befolkningen har egenskapen du ønsker å måle? En mye brukt anslag er 50 % - usikkerheten ved estimatet er størst da, så det vil gi det sikreste antallet på utvalget. 
...
Da trenger du et utvalg på 385 personer (eller enheter). Formelen er en omforming av den opprinnelige standardfeil-formelen:
...
For å si noe om alle kommunene, holder det med et utvalg på 186 kommuner. 
...
Når undergrupper i en populasjon har stor variasjon i verdiene sine, eller er interessante i seg selv, eller du allerede veit mye om noen grupper, kan det lønne seg å ta et stratifisert utvalg: dele populasjonen opp i grupper, og trekke tilfeldighetsutvalg fra hver gruppe. 
