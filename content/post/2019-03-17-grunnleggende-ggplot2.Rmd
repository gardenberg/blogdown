---
title: Grunnleggende ggplot2 - andeler fylkeskommunale utgifter
author: Eivind
date: '2019-03-17'
...
Interessert i å lære grunnleggende R-koding og visualisering? Det finnes dårligere ideer enn å kikke innom datacamp-kurset [om beste praksis for visualisering](https://campus.datacamp.com/courses/visualization-best-practices-in-r/). 

- Selv om det er __helt voldsomt mye gratis__ tilgjengelig et google-søk unna, betyr det også at det kan ta tid å luke ut det gode fra det vonde, skille snørr og kanel, og så videre. Dette kurset gir i hvert fall et inntrykk av å være basert på (primo 2019) "beste praksis".
- Etter hvert begynner også en del tutorials å bli utdaterte. Særlig ggplot2 har utvikla seg noe etter hvert, og tidlige eksempler bruker gjerne bare base-funksjoner (uten at jeg skal starte [den diskusjonen](https://flowingdata.com/2016/03/22/comparing-ggplot2-and-r-base-graphics/)).

Her er en kort oppsummering av det jeg plukka med meg om:

#Hvordan vise fram andeler av et hele

En vanlig feil i datavisualiseringer er å bruke teknikker ment for andelsdata, på data som ikke er andeler. Visualiseringer som kurset diskuterer for å vise andeler er
